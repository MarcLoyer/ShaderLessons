...
public class Lesson1Screen implements Screen {
    public ShaderLessons game;

    public Texture tex;
    public ShaderProgram shader;
    public SpriteBatch batchL1;

    public OrthographicCamera cam;
    public InputMultiplexer inputControllerMultiplexer;
    public Stage stage;

    public Lesson1Screen(final ShaderLessons game) {
        this.game = game;
...
//        stage.setDebugAll(true);
    ...
    public void create() {
        ...
        shader = new ShaderProgram(
                Gdx.files.internal("shaders/lesson1.vert"),
                Gdx.files.internal("shaders/lesson1.frag")
        );
        ...
        batchL1 = new SpriteBatch(1000, shader);
        batchL1.setShader(shader);
    }
    ...
    public void render(float delta) {
        ...
        batchL1.begin();
        batchL1.draw(tex, 50, 50);
        batchL1.draw(tex, 500, 50, 32, 32);
        batchL1.end();
    }
    ...
    public void resize(int width, int height) {
        ...
        batchL1.setProjectionMatrix(cam.combined);
